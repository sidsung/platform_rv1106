...
int post_process(rknn_app_ctx_t *app_ctx, void *outputs,  float conf_threshold, float nms_threshold, object_detect_result_list_t *od_results)
{
    ...
    memset(od_results, 0, sizeof(object_detect_result_list_t));
